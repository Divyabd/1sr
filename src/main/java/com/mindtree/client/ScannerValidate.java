	...
	public static String getRoomType() {
		...
		while (true) {
			if (scanner.hasNextLine()) {
				string = scanner.nextLine();
				if (string != null)
					if (string.compareTo("luxury") == 0 || string.compareTo("semiluxury") == 0 || string.compareTo("delux")==0) {
						break;
					} else {
						System.out.println("this type of room type not valied");
					}
			} else {
				System.out.println("Null pointer exception");
				scanner.nextLine();
	...
	public static String getTrack() {
		...
		while (true) {
			if (scanner.hasNextLine()) {
				string = scanner.nextLine();
				if (string != null)
					if (string.compareTo("java") == 0 || string.compareTo(".net") == 0 ||string.compareTo("devops") == 0 ||string.compareTo("sap") == 0 ||
							string.compareTo("mms") == 0 ||string.compareTo("tester") == 0) {
						break;
					} else {
						System.out.println("this type of track not valied");
					}
			} else {
				System.out.println("Null pointer exception");
				scanner.nextLine();
